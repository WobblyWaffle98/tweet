...
with tab3:
    ...
    # Assuming you have a DataFrame named 'data' containing your dataset
    formatted_df['Market Net Premium, USD'] = round(formatted_df['Market Upper Premium, USD']) - round(formatted_df['Market Lower Premium, USD'])
    ...
    formatted_df['Current Value, USD'] = formatted_df['Market Net Premium, USD'] * formatted_df['FO.Position_Quantity']
