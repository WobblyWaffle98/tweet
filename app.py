...
with tab2:
   ...
   # Define the color for all cells
    ...
    st.plotly_chart(fig3, use_container_width=True)
     ...
     # Convert the chart to an image with higher resolution
    image = fig3.to_image(format="png", width=1200, height=500, scale=2.0)
    ...
    with col1:
        ...
        fig1.update_traces(text=text_values['text'], textposition='inside', texttemplate='%{text:.2s}')
...
with tab4:
    ...
    pdf.image(r"Resources\Plots\lower_put_options.png", x=105, y=pdf.get_y(), w=100) 
